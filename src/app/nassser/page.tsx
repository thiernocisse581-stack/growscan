        ...
        <div className="p-8 rounded-3xl bg-slate-900/95 border border-slate-800 shadow-2xl space-y-6 text-center backdrop-blur-2xl">
          ...
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-400 text-xs font-bold">
              <Key className="w-3.5 h-3.5" /> Portail Secret d'Administration
            </div>
            <h1 className="text-2xl font-black text-white">Connexion Administrateur Secret</h1>
          ...
          <div className="pt-3 border-t border-slate-800 text-center space-y-1">
            <p className="text-[11px] text-slate-400 font-semibold flex items-center justify-center gap-1.5">
              ...
              Zone Administrateur Secret Strictement Protégée
            </p>
        ...
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <span className="px-3 py-1 rounded-full bg-indigo-500/20 text-indigo-400 border border-indigo-500/30 text-xs font-extrabold flex items-center gap-1.5 shadow-sm">
              <ShieldCheck className="w-3.5 h-3.5 text-emerald-400" /> Administration Principale (/nassser)
            </span>
          ...
          <h1 className="text-3xl font-black text-white tracking-tight">
            GrowScan Secret Admin Dashboard
          </h1>
        </div>
